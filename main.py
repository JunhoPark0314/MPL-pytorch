...
def train_loop(args, labeled_loader, unlabeled_loader, test_loader,
	...
	for step in range(args.start_step, args.total_steps):
		...
		pbar.set_description(
            ...
            f"T_Loss: {t_losses.avg:.2f}. Mask: {mean_mask.avg:.2f}. T_Loss_l: {t_losses_l.avg:.2f}. T_Loss_u: {t_losses_u.avg:.2f}. T_Loss_mpl: {t_losses_mpl.avg:.2f}"
			f"DP: {dot_product_mean.avg:.2f}")
		pbar.update()
...
def main():
	...
	t_scheduler = lr_scheduler.ReduceLROnPlateau(t_optimizer)
